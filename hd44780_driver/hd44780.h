...
// ENTRY MODE MACROS
//-------------------------------
#define ENTRY_MODE_DEC_NO_SHIFT			0x04u // ������ ������, ��� ������ ������� ����� DDRAM ������
#define ENTRY_MODE_DEC_WITH_SHIFT     	0x05u // ������ ������, �� ������� ������� ����� DDRAM ������
#define ENTRY_MODE_INC_NO_SHIFT	      	0x06u // ����� �������, ��� ������ ������� ����� DDRAM ������
#define ENTRY_MODE_INC_WITH_SHIFT     	0x07u // ����� �������, �� ������� ������� ����� DDRAM ������
...
void Lcd_LoadAndDrawUserChar(uint8_t *vector, uint8_t position, uint8_t line, uint8_t address);
